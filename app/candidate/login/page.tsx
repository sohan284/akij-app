  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 bg-[#f8f9fa]">
        ...
        <Card
          className="border border-slate-100 bg-white flex flex-col w-[343px] h-[341px] md:w-[571px] md:h-[373px] rounded-[16px] pt-[24px] px-[16px] pb-[24px] md:pt-[32px] md:px-[32px] md:pb-[40px] gap-[10px]"
        >
